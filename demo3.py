...
while True:
    if myserver.centerx and myserver.centery:
        ...
        # joints_x-=15
        if myserver.move:
            joints_0 = [joints_x, 130, 0, 0, 265, 30]
            arm.Arm_serial_servo_write6_array(joints_0, 1000)
            time.sleep(0.5)
        elif myserver.catch:
            print("in")
            joints_0 = [joints_x, 80, 0, 0, 265, 30]
            arm.Arm_serial_servo_write6_array(joints_0, 1000)
            time.sleep(0.5)
        elif myserver.out:
            print("oin")
            joints_0 = [0, 130, 0, 0, 265, 30]
            arm.Arm_serial_servo_write6_array(joints_0, 1000)
            time.sleep(0.5) 
        # joints_0 = [joints_x, 130, 90, 0, 265, 30]
        # arm.Arm_serial_servo_write6_array(joints_0, 500)
        # time.sleep(0.5)
        # joints_0 = [0, 80, 0, 0, 265, 30]
        # arm.Arm_serial_servo_write6_array(joints_0, 6000)
        # time.sleep(0.5)
        # joints_0 = [xy[0], xy[1], 0, 0, 90, 30]
        # arm.Arm_serial_servo_write6_array(joints_0, 1000)
        # time.sleep(0.5)
